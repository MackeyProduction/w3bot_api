...
class LayoutEngine
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Software", mappedBy="layoutEngine")
     */
    private $softwares;
    ...
    public function removeSoftware(Software $software): self
    {
        if ($this->softwares->contains($software)) {
            ...
            if ($software->getLayoutEngine() === $this) {
                $software->setLayoutEngine(null);
            }
        }
